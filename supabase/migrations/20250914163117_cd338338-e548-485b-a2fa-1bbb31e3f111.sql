...
-- Update RLS policies safely by dropping and recreating only if needed
DO $$
BEGIN
    ...
    IF EXISTS (
        ...
        DROP POLICY "Admins can manage all coupons" ON public.coupons;
    END IF;
    ...
    IF EXISTS (
        ...
        WHERE schemaname = 'public' 
        AND tablename = 'coupons' 
        AND policyname = 'Authenticated users can view active coupons'
    ) THEN
    ...
    IF EXISTS (
        ...
        WHERE schemaname = 'public' 
        AND tablename = 'coupons' 
        AND policyname = 'Admins can select all coupons'
    ) THEN
        DROP POLICY "Admins can select all coupons" ON public.coupons;
    END IF;
    ...
    IF EXISTS (
        ...
        DROP POLICY "Admins can insert coupons" ON public.coupons;
    END IF;
    ...
    IF EXISTS (
        ...
        WHERE schemaname = 'public' 
        AND tablename = 'coupons' 
        AND policyname = 'Admins can update all coupons'
    ) THEN
        DROP POLICY "Admins can update all coupons" ON public.coupons;
    END IF;
    ...
    IF EXISTS (
        ...
        WHERE schemaname = 'public' 
        AND tablename = 'coupons' 
        AND policyname = 'Admins can delete all coupons'
    ) THEN
        DROP POLICY "Admins can delete all coupons" ON public.coupons;
    END IF;
END $$;
