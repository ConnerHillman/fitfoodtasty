-- Add salt and saturated fat columns to ingredients table
ALTER TABLE public.ingredients 
ADD COLUMN IF NOT EXISTS saturated_fat_per_100g NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS salt_per_100g NUMERIC DEFAULT 0;

-- Add salt and saturated fat columns to meals table
ALTER TABLE public.meals 
ADD COLUMN IF NOT EXISTS total_saturated_fat NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS total_salt NUMERIC DEFAULT 0;

-- Update the calculate_meal_nutrition function to include salt and saturated fat
...
BEGIN
  ...
  INTO total_cals, total_prot, total_carb, total_f, total_sat_f, total_fib, total_sug, total_salt, total_sod, total_wt
