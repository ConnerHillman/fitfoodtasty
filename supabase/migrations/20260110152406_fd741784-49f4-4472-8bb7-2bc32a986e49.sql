...
-- Update the active email template with correct variables and optimal design
    ...
    <tr>
      <td align="center" style="padding: 20px 10px;">
        <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); border-radius: 12px;">
                <tr>
                  <td align="center" style="padding: 25px 20px;">
                    ...
                    <h1 style="color: #ffffff; font-size: 24px; font-weight: bold; margin: 15px 0 5px 0;">Order Confirmed!</h1>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px;">
                <tr>
                  <td style="padding: 20px;">
                    <h2 style="color: #166534; font-size: 18px; font-weight: bold; margin: 0 0 15px 0; border-bottom: 1px solid #bbf7d0; padding-bottom: 10px;">Order Details</h2>
          ...
          <tr>
            <td style="padding: 0 20px 20px 20px;">
              <h2 style="color: #1f2937; font-size: 18px; font-weight: bold; margin: 0 0 15px 0;">Your Order</h2>
